...
public class EventUser {
    ...
    public EventUser(long id, String email, String password, String firstName,
    ...
    public EventUser(String email, String password, String firstName,
    ...
    public String toString() {
        return "EventUser{id=" + id + ", email='" + email + "', firstName='" + firstName + "'}";
    }
}

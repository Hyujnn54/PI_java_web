...
public class GrokAIService {
    ...
    private String callGrokAPI(String prompt) throws Exception {
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            System.err.println("Erreur API Grok (" + responseCode + "): " + errorResponse.toString());
    ...
    private String extractMessageFromResponse(String jsonResponse) {
        try {
            // Extraction simple du contenu du message depuis la réponse JSON
            // Format attendu: {"choices":[{"message":{"content":"..."}}]}
            ...
            // Trouver la vraie fin (en tenant compte des guillemets échappés)

...
public class MyDatabase {
    ...
    public Connection getConnection() {
        try {
            // Si la connexion est nulle ou fermée ou invalide, on tente de la recréer
            if (connection == null || connection.isClosed() || !connection.isValid(2)) {
                System.out.println("Database connection lost or closed. Reconnecting...");
    ...
    private MyDatabase() {
        // La première connexion est établie ici, mais getConnection() gérera les
        // déconnexions futures
        getConnection();
    }
